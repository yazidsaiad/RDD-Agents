...
def app():
    ...
    st.markdown("<h1 style='text-align: center; color: black; font-size : 25px;'>Récupération des absences</h1>", unsafe_allow_html=True)
    st.divider()
    ...
    if  df_idap.empty or df_control.empty:
        ...
        output = utils.format_absence_oir(idap_data=df_idap, control_data=df_control)
